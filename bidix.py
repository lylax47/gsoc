...
GLOSBE = 'https://glosbe.com/cs/ru/'
PONS = 'http://en.pons.com/translate?q={0}&l=csru&in=&lf=cs'
WIKI = 'https://cs.wiktionary.org/wiki/{0}'
...
def change_dict(new_tr):
    ...
    # print(etree.tostring(new_tr, encoding='utf8').decode('utf8'))
    new_section = delete_prev(section, new_tr)
    # print(etree.tostring(new_section, encoding='utf8').decode('utf8'))
